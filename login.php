...
if(!empty($_POST['email']) && !empty($_POST['password'])):
	...
	$records = $conn->prepare('SELECT user_id,fname,email,password FROM user_details WHERE email = :email');
	...
	<div class="banner-top container-fluid" id="home">
		...
		<form class="register" action="login.php" method="POST">
			<center>
	        	...
	        	<input name ="email" type="text" class="register-input" placeholder="Enter Your Email Adress" autofocus>
